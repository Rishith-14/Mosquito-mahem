...
if(mousePressedOver(restart)){
	...
	stroke("black")
	strokeWeight(3)
	text("MOSQUITOES KILLED- "+score,(windowWidth/2)-150,100)
	fill("red")
	stroke("black")
	strokeWeight(3)
	text("BITES- "+bite,(windowWidth/2)-350,100)
}
